...
//      to automatically handle Up button behavior based on the navigation graph.
        ...
        NavigationUI.setupWithNavController(toolbar, navController, new AppBarConfiguration.Builder(R.id.DestHome, R.id.DestCarbonFootprint, R.id.DestReforestation, R.id.DestProfile).setDrawerLayout(drawerLayout).build());
